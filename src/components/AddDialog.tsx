...
import { ReactComponent as RemoveIcon } from "../icons/remove_circle.svg";
            ...
            >
                ...
                <div className="-contents">
                    ...
                    <div className="dropMessage">
                        ...
                        <p>
                            Imported files will not be validated. This process has
                            minimal error-checking and non-conformant files may crash the
                            app. If this happens, you can recover by clearing cookies and
                            website data.
                        </p>
                    </div>
...
function ImportItem({ item, remove }: { item: FileImport; remove: () => void }) {
    let stats = [
        ...
        {
            name: "Publisher",
            value: item.data ? item.data.book.publisher : null,
        },
        {
            name: "Contains",
            value: item.data
                ? `${Object.keys(item.data.book.pages).length} pages`
                : null,
        },
    ];
    return (
